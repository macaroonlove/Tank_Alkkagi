...
public class p1Tank : MonoBehaviour
{
    Rigidbody rigid;
    ...
    void End()
    {
        GetComponent<p1Tank>().enabled = false;
        player[1].GetComponent<Player2>().enabled = true;
        player[0].GetComponent<Player1>().enabled = false;
